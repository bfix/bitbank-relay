...
func (hdlr *DashHandler) GetAddress(ed *wallet.ExtendedData) (string, error) {
	...
	switch ed.Version {
	case wallet.DrkpVersion:
		return wallet.MakeAddress(pk, 5, wallet.AddrP2PKH, wallet.AddrMain), nil
	case wallet.YpubVersion:
		return wallet.MakeAddress(pk, 5, wallet.AddrP2SH, wallet.AddrMain), nil
	}
