...
func init() {
	handlers["nmc"] = &NmcHandler{}
}

type NmcHandler struct {
}

// GetAddress returns a wallet address.
func (hdlr *NmcHandler) GetAddress(ed *wallet.ExtendedData) (string, error) {
	...
	case wallet.XpubVersion:
		return wallet.MakeAddress(pk, 7, wallet.AddrP2PKH, wallet.AddrMain), nil
	case wallet.YpubVersion:
		return wallet.MakeAddress(pk, 7, wallet.AddrP2SH, wallet.AddrMain), nil
	}
