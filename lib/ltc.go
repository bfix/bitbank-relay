...
func (hdlr *LtcHandler) GetAddress(ed *wallet.ExtendedData) (string, error) {
	...
	case wallet.XpubVersion:
		return wallet.MakeAddress(pk, 2, wallet.AddrP2PKH, wallet.AddrMain), nil
	case wallet.MtubVersion:
		return wallet.MakeAddress(pk, 2, wallet.AddrP2SH, wallet.AddrMain), nil
	}
