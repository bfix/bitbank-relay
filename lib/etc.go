...
func (hdlr *EtcHandler) GetAddress(ed *wallet.ExtendedData) (string, error) {
	...
	case wallet.XpubVersion:
		return wallet.MakeAddress(pk, 61, wallet.AddrP2PKH, wallet.AddrMain), nil
	case wallet.YpubVersion:
		return wallet.MakeAddress(pk, 61, wallet.AddrP2SH, wallet.AddrMain), nil
	}
